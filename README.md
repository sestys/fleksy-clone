...
| Swipe up / down | next / previous suggestion for the last word. The word you typed is always leftmost; swipe down ends on it, another swipe down learns it ("✓ learned"), another forgets it ("✓ forgotten") |
